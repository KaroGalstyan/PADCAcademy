...
type ExamScheduleSelectScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "ExamScheduleSelect"
>;
  ...
  return (
    <ScrollView className="flex-1 bg-[#F8F8F8] px-[15px] pt-10">
      ...
      <Calendar
        ...
        markedDates={
          selectedDate ? { [selectedDate]: { selected: true, selectedColor: "#A09DD9" } } : {}
        }
        theme={{
      ...
      <Text
        ...
        className="text-[20px] font-poppinsSemiBold mb-[17px] mx-[5px]"
      >
        Pick a time
      </Text>
