			...
			<ScrollView className="bg-[#F8F8FA]" >
				...
				<View className="px-5 pb-6">
					<Text className="text-[14px] text-black leading-[30px]">
						...
						processes and procedures that systematically monitors different aspects of a product or a
						service. {"\n"}
						By regular audits and other forms of assessments, QA detects and fixes the problems or
						variances that fall outside of organized standards or requirements. To release a product as a
						whole for the first time in production or to release an update, QA is mandatory. Every piece
						of code needs to be tested regressively before it is released to the market. {"\n"}
						And in today’s agile world, with frequent build updates QA becomes a challenging and
						time-consuming task. QA automation is the solution to such problems as it replaces manual
						efforts with automated scripts to speed up workflows and improve the quality assurance
						(QA) process’s efficiency. While manual testing will always be vital, automation may save
						time and money.
					</Text>
				</View>
				...
				<View className="px-5 mb-10">
					<Text className="text-xl font-poppinsBold text-black">
						If you are interested in being immersed in the software development process, a QA testing job could be the right fit for you.
					</Text>
				</View>
			</ScrollView>
		</SafeAreaView>
