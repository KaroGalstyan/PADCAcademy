			...
			<ScrollView showsVerticalScrollIndicator={false}>
				...
				>
					<View className="mb-10">
						<Text className="text-white text-[22px] font-poppinsBold mb-4">
							ABOUT OUR PRODUCT
						</Text>
						<Text className="text-white text-base leading-[26px]">
							...
							Interdum et malesuada fames ac ante ipsum primis in faucibus. Pellentesque efficitur eu ex non blandit.
							Sed at lorem efficitur, pellentesque urna sed, sodales nunc. Pellentesque efficitur eu ex non blandit.
							Sed at lorem efficitur, pellentesque urna sed, sodales nunc.
						</Text>
					</View>
